/* //!in next it's very easy to make a route like i need / cabins or /about and so on
    ! here you don't need to install react-router-dom or anything else
    ! you just need to create a folder with the name of the route you want
    ! and inside that folder you create a page.js file which will be the component
    ! that will be rendered when you navigate to that route
    ! for example if you want to create an about page you create a folder called about
    ! and inside that folder you create a page.js file which will be the component 
    ! it's a convention to name it page but you can name it anything 
    
    leave all of them by the name page and we will do a trick from setting in custom lables to make difference between each page
...
export const revalidate = 86400; //? revalidate the data every 1 day
